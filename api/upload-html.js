module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const newCard = `
      <!-- Card ${cardTitle} -->
      <div class="card">
        <a href="layouts/${cleanName}" target="_blank" class="card-link">
        ...
        <div class="card-footer">
          ...
          <a href="layouts/${cleanName}" download="${cleanName}" class="download-btn">⬇ Baixar</a>
        </div>
      </div>
`;
